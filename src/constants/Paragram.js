...
export const WindingUpofLLPListItems = [
    ...
    {
        reason: "There are less than two Partners in the LLP for a period of more than 6 months."
    },
    {
        reason: "The LLP is not in a position to pay its debts."
    },
    {
        reason: "The LLP has acted against the interests of the sovereignty and integrity of India, the security of State or public order."
    },
    {
        reason: "The LLP has not filed with the Registrar Statement of Accounts and Solvency or LLP Annual Returns for any five consecutive financial years."
    },
    {
        reason: "The Tribunal is of the opinion that it is just and equitable that the LLP should be wound up."
    }
];
